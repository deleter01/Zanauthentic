      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Tour</h3>
          </div>
          <div class="content-header-right col-md-8 col-12">
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><b><a href="index.html">Create a tour&nbsp;<i class="la la-pencil-square-o"></i></a></b>  
                  </li>
                </ol>
              </div>
            </div>
      ...
      <div class="col-xl-3 col-lg-6 col-md-12">
          <div class="card pull-up ecom-card-1 bg-danger text-center">
              <div class="card-content ecom-card2 height-100">
                  ...
                  <h5 class="text-white"><b>Total Tours</b></h5>
              </div>
          </div>
      </div>
      <div class="col-xl-3 col-lg-6 col-md-12">
        <div class="card pull-up ecom-card-1 bg-info text-center">
            <div class="card-content ecom-card2 height-100">
                <h2 class="text-white p-1 text-center">0</h2>
                <h5 class="text-white "><b>Ended</b></h5>
            </div>
        </div>
      </div>
      <div class="col-xl-3 col-lg-6 col-md-12">
        <div class="card pull-up ecom-card-1 bg-success text-center">
            <div class="card-content ecom-card2 height-100">
                <h2 class="text-white p-1 text-center">0</h2>
                <h5 class="text-white"><b>Active</b></h5>
            </div>
        </div>
      </div>
      <div class="col-xl-3 col-lg-6 col-md-12">
        <div class="card pull-up ecom-card-1 bg-dark text-center">
            <div class="card-content ecom-card2 height-100">
                <h2 class="text-white p-1 text-center">0</h2>
                <h5 class="text-white"><b>Inactive</b></h5>
            </div>
        </div>
  </div>
